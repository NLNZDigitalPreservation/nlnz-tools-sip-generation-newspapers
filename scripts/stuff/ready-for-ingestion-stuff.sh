...
export sourceFolder="/media/sf_Y_DRIVE/ndha/pre-deposit_prod/NDHA_submission_Rosetta/stuff-processing/pre-processing_Jul_2023/"
export targetBaseFolder="/media/sf_Y_DRIVE/ndha/pre-deposit_prod/NDHA_submission_Rosetta/stuff-processing/latest-batch-ready-ingestion"
