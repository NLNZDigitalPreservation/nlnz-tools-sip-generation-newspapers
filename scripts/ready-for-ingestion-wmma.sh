...
export sourceFolder="Y:/ndha/pre-deposit_prod/NDHA_submission_Rosetta/wairarapa_times_age/wairarapa-times-processing/pre-processing_Jun_2021"
export targetBaseFolder="Y:/ndha/pre-deposit_prod/NDHA_submission_Rosetta/wairarapa_times_age/wairarapa-times-processing/latest-batch-ready-ingestion"
