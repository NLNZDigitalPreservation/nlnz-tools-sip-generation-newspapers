...
class HasIgnoreSequenceTest {
    ...
    static final String RESOURCES_FOLDER = "ingestion-files-tests/scenario-has-ignore-sequence"
    ...
    void sipConstructedCorrectly(String sipXml) {
        ...
        TestHelper.assertExpectedSipFileValues(sipForValidation, 1, "TST-PB1-ZN-20181123-0001.pdf", "TST-PB1-ZN-20181123-0001.pdf",
                636L, "MD5", "7273a4d61a8dab92be4393e2923ad2d2", "0001", "application/pdf")

        TestHelper.assertExpectedSipFileValues(sipForValidation, 2, "TST-PB1-ZN-20181123-0002.pdf", "TST-PB1-ZN-20181123-0002.pdf",
                636L, "MD5", "7273a4d61a8dab92be4393e2923ad2d2", "0002", "application/pdf")

        TestHelper.assertExpectedSipFileValues(sipForValidation, 3, "TST-PB1-ZN-20181123-0003.pdf", "TST-PB1-ZN-20181123-0003.pdf",
                636L, "MD5", "7273a4d61a8dab92be4393e2923ad2d2", "0003", "application/pdf")

        TestHelper.assertExpectedSipFileValues(sipForValidation, 4, "TST-PB1-ZN-20181123-0004.pdf", "TST-PB1-ZN-20181123-0004.pdf",
