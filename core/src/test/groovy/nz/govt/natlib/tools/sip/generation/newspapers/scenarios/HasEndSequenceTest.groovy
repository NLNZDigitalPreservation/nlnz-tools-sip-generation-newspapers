...
class HasEndSequenceTest {
    ...
    static final String RESOURCES_FOLDER = "ingestion-files-tests/scenario-has-end-sequence"
    ...
    void sipConstructedCorrectly(String sipXml) {
        ...
        TestHelper.assertExpectedSipFileValues(sipForValidation, 3, "TVL-ED1-ZN-20181123-S001.pdf", "TVL-ED1-ZN-20181123-S001.pdf",
                636L, "MD5", "7273a4d61a8dab92be4393e2923ad2d2", "0003", "application/pdf")

        TestHelper.assertExpectedSipFileValues(sipForValidation, 4, "TVL-ED1-ZN-20181123-S002.pdf", "TVL-ED1-ZN-20181123-S002.pdf",
                636L, "MD5", "7273a4d61a8dab92be4393e2923ad2d2", "0004", "application/pdf")

        TestHelper.assertExpectedSipFileValues(sipForValidation, 5, "SUS-ED1-ZN-20181123-A001.pdf", "SUS-ED1-ZN-20181123-A001.pdf",
                636L, "MD5", "7273a4d61a8dab92be4393e2923ad2d2", "0005", "application/pdf")

        TestHelper.assertExpectedSipFileValues(sipForValidation, 6, "SUS-ED1-ZN-20181123-A002.pdf", "SUS-ED1-ZN-20181123-A002.pdf",
