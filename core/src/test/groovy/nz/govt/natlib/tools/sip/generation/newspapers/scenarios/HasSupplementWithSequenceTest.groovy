...
@Log4j2
class HasSupplementWithSequenceTest {
    ...
    static final String RESOURCES_FOLDER = "ingestion-files-tests/scenario-has-supplement-with-sequence"
    static final String IMPORT_PARAMETERS_FILENAME = "test-newspaper-types.json"
    static final String PREVIOUS_SUPPLEMENTS_ISSUES_PATH = "src/test/resources/ingestion-files-tests/scenario-has-supplement-with-sequence/supplements-previous-issues.properties"
    ...
    void processFiles(List<Path> filesForProcessing) {
        ...
        int expectedNumberOfFilesProcessed = 6
        int expectedNumberOfSipFiles = 6
        int expectedNumberOfValidFiles = 6
    ...
    void sipConstructedCorrectly(String sipXml) {
        ...
        TestHelper.assertExpectedSipFileValues(sipForValidation, 1, "SUS-ED1-ZN-20181123-0001.pdf", "SUS-ED1-ZN-20181123-0001.pdf",
                636L, "MD5", "7273a4d61a8dab92be4393e2923ad2d2", "0001", "application/pdf")

        TestHelper.assertExpectedSipFileValues(sipForValidation, 2, "SUS-ED1-ZN-20181123-0002.pdf", "SUS-ED1-ZN-20181123-0002.pdf",
                636L, "MD5", "7273a4d61a8dab92be4393e2923ad2d2", "0002", "application/pdf")

        TestHelper.assertExpectedSipFileValues(sipForValidation, 3, "TVL-ED1-ZN-20181123-T001.pdf", "TVL-ED1-ZN-20181123-T001.pdf",
                636L, "MD5", "7273a4d61a8dab92be4393e2923ad2d2", "0003", "application/pdf")

        TestHelper.assertExpectedSipFileValues(sipForValidation, 4, "TVL-ED1-ZN-20181123-T002.pdf", "TVL-ED1-ZN-20181123-T002.pdf",
                636L, "MD5", "7273a4d61a8dab92be4393e2923ad2d2", "0004", "application/pdf")

        TestHelper.assertExpectedSipFileValues(sipForValidation, 5, "TVL-ED1-ZN-20181123-S001.pdf", "TVL-ED1-ZN-20181123-S001.pdf",
                636L, "MD5", "7273a4d61a8dab92be4393e2923ad2d2", "0005", "application/pdf")

        TestHelper.assertExpectedSipFileValues(sipForValidation, 6, "TVL-ED1-ZN-20181123-S002.pdf", "TVL-ED1-ZN-20181123-S002.pdf",
