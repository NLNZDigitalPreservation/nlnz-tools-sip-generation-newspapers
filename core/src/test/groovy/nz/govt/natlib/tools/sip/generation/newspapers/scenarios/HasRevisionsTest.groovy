...
class HasRevisionsTest {
    ...
    static final String RESOURCES_FOLDER = "ingestion-files-tests/scenario-has-revisions"
    ...
    void correctlyAssembleSipFromFilesOnFilesystem() {
        ...
        TestHelper.initializeTestMethod(testMethodState, "HasRevisionsTest-", forLocalFilesystem)
    ...
    void processFiles(List<Path> filesForProcessing) {
        ...
        int expectedNumberOfInvalidFiles = 2
    ...
    void sipConstructedCorrectly(String sipXml) {
        ...
        TestHelper.assertExpectedSipFileValues(sipForValidation, 1, "acpDZ3222p001_R2-010822.pdf", "acpDZ3222p001_R2-010822.pdf",
                636L, "MD5", "7273a4d61a8dab92be4393e2923ad2d2", "0001", "application/pdf")

        TestHelper.assertExpectedSipFileValues(sipForValidation, 2, "acpDZ3222p002_PRE-010822.pdf", "acpDZ3222p002_PRE-010822.pdf",
