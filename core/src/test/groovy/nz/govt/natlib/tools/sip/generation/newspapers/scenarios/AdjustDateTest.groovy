...
class AdjustDateTest {
    ...
    static final String RESOURCES_FOLDER = "ingestion-files-tests/scenario-adjust-date"
    ...
    void correctlyAssembleSipFromFilesOnFilesystem() {
        ...
        TestHelper.initializeTestMethod(testMethodState, "AdjustDateTest-", forLocalFilesystem)
    ...
    void processFiles(List<Path> filesForProcessing) {
        ...
        List<NewspaperProcessingParameters> parametersList = NewspaperProcessingParameters.build("ZW",
    ...
    void sipConstructedCorrectly(String sipXml) {
        ...
        TestHelper.assertExpectedSipMetadataValues(sipForValidation, "New Zealand woman's weekly", "2022", "08", "08",
                IEEntityType.MagazineIE, "ALMAMMS", "test-mms-id-one", "200",
                "PRESERVATION_MASTER", "VIEW", true, 1)

        TestHelper.assertExpectedSipFileValues(sipForValidation, 1, "acpZW3222p001_COV-010822.pdf", "acpZW3222p001_COV-010822.pdf",
                636L, "MD5", "7273a4d61a8dab92be4393e2923ad2d2", "0001", "application/pdf")

        TestHelper.assertExpectedSipFileValues(sipForValidation, 2, "acpZW3222p002_PRE-010822.pdf", "acpZW3222p002_PRE-010822.pdf",
                636L, "MD5", "7273a4d61a8dab92be4393e2923ad2d2", "0002", "application/pdf")

        TestHelper.assertExpectedSipFileValues(sipForValidation, 3, "acpZW3222p003_Qualifier-010822.pdf", "acpZW3222p003_Qualifier-010822.pdf",
