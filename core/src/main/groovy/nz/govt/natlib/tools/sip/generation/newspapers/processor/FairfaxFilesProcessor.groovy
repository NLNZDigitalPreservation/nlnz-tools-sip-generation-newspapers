...
class FairfaxFilesProcessor {
    ...
    Map<NewspaperFile, NewspaperFile> processedFairfaxFiles
    ...
    void processFile(NewspaperFile newspaperFile) {
        ...
        if (processedFairfaxFiles.containsKey(newspaperFile)) {
            ...
            processedFairfaxFiles.put(newspaperFile, newspaperFile)
    ...
    String generateSipAsXml(List<NewspaperFile> sortedFairfaxFiles, LocalDate sipDate) {
        String sipAsXml = ""
        if (sortedFairfaxFiles.isEmpty()) {
            ...
            List<Path> filesForSip = sortedFairfaxFiles.collect() { NewspaperFile newspaperFile ->
                newspaperFile.file
            }
