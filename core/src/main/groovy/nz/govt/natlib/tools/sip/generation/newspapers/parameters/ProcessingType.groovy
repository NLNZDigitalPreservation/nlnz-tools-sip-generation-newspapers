...
enum ProcessingType {
    ...
    ParentGroupingWithEdition("parent_grouping_with_edition",
            [ ProcessingRule.SkipIgnored, ProcessingRule.SkipUnrecognised, ProcessingRule.SkipInvalid,
              ...
              ProcessingRule.UseNumberForMetsLabel ],
    ...
    SupplementGrouping("supplement_grouping",
            [ ProcessingRule.SkipIgnored, ProcessingRule.SkipUnrecognised, ProcessingRule.SkipInvalid,
              ...
              ProcessingRule.UseNumberForMetsLabel ],
            [ ProcessingOption.NumericBeforeAlphaSequencing ]),
    SupplementWithDateAndIssue("supplement_with_date_and_issue",
            [ ProcessingRule.SkipIgnored, ProcessingRule.SkipUnrecognised, ProcessingRule.SkipInvalid,
              ProcessingRule.Automatic, ProcessingRule.FirstSectionCodeRequiredForMatch,
              ProcessingRule.AllSectionsInSipOptional, ProcessingRule.MissingSequenceError,
              ProcessingRule.MissingSequenceDoubleWideIgnored, ProcessingRule.IgnoreEditionsWithoutMatchingFiles,
              ...
              ProcessingRule.NumericStartsInHundredsNotConsideredSequenceSkips, ProcessingRule.IsMultiPdfFiles,
              ProcessingRule.UseNumberForMetsLabel ],
            [ ProcessingOption.NumericBeforeAlphaSequencing, ProcessingOption.FullDateInSip,
              ProcessingOption.DcIssuedField ]),
